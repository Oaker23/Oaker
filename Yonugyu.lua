...
local Flux = loadstring(game:HttpGet"https://raw.githubusercontent.com/Oaker23/Oaker/main/script1.lua")()
local win = Flux:Window("Blox Fruit", "GODDard", Color3.fromRGB(51,224, 255), Enum.KeyCode.LeftControl)
...
AutoFarm:Toggle("Hide HitBlox","",false,function(Value)
    HideHitBlox = Value  
end)
AUTOHAKI = true
AutoFarm:Toggle("Auto Haki","",true,function(Value)
    AUTOHAKI = Value  
end)
AutoFarm:Toggle("Auto Observation haki","",false,function(Value)
    AUTOHAKIObs = Value  
end)
spawn(function()
    while wait() do
